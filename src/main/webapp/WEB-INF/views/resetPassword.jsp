        ...
        <div class="row">
            ...
            <div class="wrapper">
                ...
                <div class="container">
                    ...
                    <form:form modelAttribute="resetPassword"  action="setNewPassword" id="form" method='put'>
                        ...
                        <form:input type="password" placeholder="Password" name="password" path="newPassword" required="required" id="password"></form:input>

                        <label><b>Confirm Password</b></label>
                        <form:input type="password" placeholder="Confirm Password" name="confirmPassword" path="confirmPassword" required="required" id="confirmpassword"></form:input>
                        <button type="submit" id="resetsubmit">Save</button>
                    </form:form>
