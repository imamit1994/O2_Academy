                    ...
                    <div>
                        <table class="table ">
                            <tr>
                                ...
                                <td class="cell"><input type="text" placeholder="Enter Name" path="associateId" required="required" id="associateId" value="${userInfo.name}"/></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="cell"><b>Change Password</b></td>
                                <td class="cell"><button style="width: 50%" type="submit" id="updatePassword" formaction="editApassword">Reset Password</button></td>
                            </tr>

                        </table>
                    </div>
                        <button  type="submit" id="updateDetails" formaction="">Save Info</button>
